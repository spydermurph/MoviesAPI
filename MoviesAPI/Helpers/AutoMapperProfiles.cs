...
namespace MoviesAPI.Helpers
{
    public class AutoMapperProfiles: Profile
    {
        ...
        private List<MovieTheaterDTO> MapMovieTheatersMovies(Movie movie, MovieDTO movieDTO)
        {
            ...
            {
                foreach (var movieTheaterMovie in movie.MovieTheatersMovies)
                {
                    result.Add(new MovieTheaterDTO() { Id = movieTheaterMovie.MovieTheaterId, 
                        Name = movieTheaterMovie.MovieTheater.Name, 
                        Latitude = movieTheaterMovie.MovieTheater.Location.Y, 
                        Longitude = movieTheaterMovie.MovieTheater.Location.X});
                }
            }
